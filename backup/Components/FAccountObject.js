...
var FAccountObject = (function (_super) {
    ...
    function FAccountObject(props) {
        ...
        _this.setTextFieldValues = function () {
            console.log(_this.text, "--", _this.text.length);
        ...
        _this.triggerValueChangedForSubAccountNumber = function (subAccount) {
            ...
            if (implementationLevel == "S" || implementationLevel == "T") {
                console.log(_this.product.ProductId.trim().padEnd(8, ' '));
                console.log("00000000");
                console.log(_this.state.accountId.padStart(8, '0'));
        ...
        _this.accountRowSelect = function (evt, selectedAccount) {
            ...
            console.log("Account: " + _this.account, _this.account.AccountNo);
        ...
        console.log("State Text: ", _this.state.text);
        console.log("Text: ", _this.text);
        return _this;
    }
            ...
            react_1.default.createElement(Grid_1.default, { container: true },
                react_1.default.createElement(Grid_1.default, { container: true, spacing: 1, justify: "center" },
                    react_1.default.createElement(Grid_1.default, { item: true, xs: 4 },
                        react_1.default.createElement(core_1.TextField, { variant: this.props.variant, error: this.state.error, onKeyDown: this.onProductKeyDown, inputRef: function (ref) { _this.prdIdRef = ref; }, value: this.state.productId, onChange: this.onChangeProductId, onBlur: this.onBlurProductId, disabled: this.state.productTBDisabled, InputProps: { className: classes.input }, InputLabelProps: { shrink: true } })),
                    react_1.default.createElement(Grid_1.default, { item: true, xs: 4 },
                        react_1.default.createElement(core_1.TextField, { variant: this.props.variant, error: this.state.accountError, inputRef: function (ref) { _this.accIdRef = ref; }, disabled: this.state.accountTBDisabled, value: this.state.accountId, onChange: this.onChangeAccountId, onBlur: this.onBlurAccountId, onKeyDown: this.onAccountKeyDown, InputProps: { className: classes.input }, InputLabelProps: { shrink: true } })),
                    react_1.default.createElement(Grid_1.default, { item: true, xs: 4 },
                        react_1.default.createElement(core_1.TextField, { variant: this.props.variant, error: this.state.subAccountError, inputRef: function (ref) { _this.subIdRef = ref; }, value: this.state.subAccountId, onChange: this.onChangeSubAccountId, disabled: this.state.subAccountTBDisabled, onKeyDown: this.onSubAccountKeyDown, InputProps: { className: classes.input }, InputLabelProps: { shrink: true } })),
                    react_1.default.createElement(Grid_1.default, { item: true, xs: 12 },
                        react_1.default.createElement(core_1.TextField, { variant: "filled", fullWidth: true, disabled: false, hidden: !descVisible, inputProps: { readOnly: true, tabIndex: -1 }, inputRef: function (ref) { _this.anchorRef = ref; }, value: this.state.description, InputProps: { className: classes.input }, InputLabelProps: { shrink: true } }))),
