...
var ArrowRightSharp_1 = __importDefault(require("@material-ui/icons/ArrowRightSharp"));
    ...
    function FLookupFieldList(props) {
        ...
        _this.rowSelect = function (evt, selectedRow) {
            _this.setState(function () {
                ...
                console.log("setting, ", _this.state.sFieldValue);
                if (_this.props.onChange) {
                    _this.props.onChange({
                        lookupId: _this.state.pFieldValue,
                        lookupDescription: _this.state.sFieldValue,
        ...
        return (react_1.default.createElement(Grid_1.default, { container: true },
            react_1.default.createElement(Grid_1.default, { container: true, spacing: 0, style: { alignItems: 'center' } },
                react_1.default.createElement(Grid_1.default, { item: true },
                    react_1.default.createElement(core_1.TextField, { required: required, error: this.state.error, variant: "outlined", label: lookupIdPlaceholder, value: this.state.pFieldValue, onKeyDown: this.lookupId_onKeyDown, inputRef: function (ref) { _this.anchorRef = ref; }, onBlur: this.lookupId_onBlur, onChange: this.lookupId_onChange, InputProps: {
                            className: classes.input
                        }, InputLabelProps: { shrink: true } })),
                react_1.default.createElement(Grid_1.default, { item: true, hidden: !descriptionVisible },
                    react_1.default.createElement(ArrowRightSharp_1.default, null)),
                react_1.default.createElement(Grid_1.default, { item: true, hidden: !descriptionVisible },
                    react_1.default.createElement(core_1.TextField, { variant: "outlined", inputProps: { readOnly: true, tabIndex: -1 }, label: descriptionPlaceholder, value: this.state.sFieldValue, InputProps: {
                            className: classes.input
                        }, InputLabelProps: { shrink: true } }))),
...
//# sourceMappingURL=FLookupFieldList.js.map