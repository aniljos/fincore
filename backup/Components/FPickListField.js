...
var FPickListField = (function (_super) {
    ...
    function FPickListField(props) {
                ...
                switch (_b.label) {
                    case 0:
                        ...
                        data = {
                            ...
                            PicklistName: pickListName,
                            ParamArr: pickListArgs,
                            TBVal: this.state.pickId,
                            DbConnName: dbConnName,
                            KeyVal: this.state.pickId
                        };
                        return [4, axios_1.default.post(url, data)];
                    case 1:
                        response = _b.sent();
        ...
        _this.generateList = function () {
            if (_this.state.pickListData) {
                var _a = _this.state.pickListData, PicklistHeader = _a.PicklistHeader, PickDt = _a.PickDt;
    ...
    FPickListField.prototype.componentDidMount = function () {
        ...
        if (this.props.data && this.props.data.pickId) {
            this.onLoadfetchListCheckInitPicklistDB(this.props.data.pickId, function (result) {
                var PicklistTBOrder = result.PicklistTBOrder, DictOne = result.DictOne;
                var PicklistTBOrderArr = PicklistTBOrder.split(",");
                _this.setState({
                    pickId: DictOne[PicklistTBOrderArr[0]],
                    pickDesc: DictOne[PicklistTBOrderArr[1]]
                }, function () {
                    _this.isValid = true;
                    _this.raiseResultChangeEvent();
                });
    ...
    FPickListField.prototype.raiseResultChangeEvent = function () {
        ...
        if (this.props.onResultChange) {
            this.props.onResultChange({
                ...
                pickDescription: this.state.pickDesc ? this.state.pickDesc.trim() : undefined
            });
        }
    };
        ...
        return (react_1.default.createElement(react_1.Fragment, null,
            ...
            react_1.default.createElement(core_1.Grid, { container: true, spacing: 0, style: { alignItems: 'center' } },
                react_1.default.createElement(core_1.Grid, { item: true },
                    react_1.default.createElement(TextField_1.default, { variant: "outlined", onKeyDown: this.onSearchKeyDown, inputRef: function (ref) { _this.pickFieldRef = ref; }, value: this.state.pickId, onChange: this.onPickIdChange, onBlur: this.onPickIdBlur, error: this.state.error, InputProps: {
                            className: classes.input
                        }, InputLabelProps: { shrink: true } })),
                react_1.default.createElement(core_1.Grid, { item: true },
                    react_1.default.createElement(ArrowRightOutlined_1.default, { color: "primary" })),
                descriptionVisible ? react_1.default.createElement(core_1.Grid, { item: true },
                    react_1.default.createElement(TextField_1.default, { variant: "outlined", disabled: true, value: this.state.pickDesc, InputProps: {
                            className: classes.input
                        }, InputLabelProps: { shrink: true } })) : null),
