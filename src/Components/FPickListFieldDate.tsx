...
interface FPickListFieldProps {
    ...
    componentRef?: (ref: FPickListFieldDate) => void,
...
export class FPickListFieldDate extends PureComponent<FPickListFieldProps> {
...
export default withStyles(styles)(FPickListFieldDate);